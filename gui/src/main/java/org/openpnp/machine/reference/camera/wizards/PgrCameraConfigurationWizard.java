...
import org.openpnp.machine.reference.camera.PgrCamera;
...
public class PgrCameraConfigurationWizard extends JPanel implements Wizard {
	private final PgrCamera camera;
	...
	public PgrCameraConfigurationWizard(
			PgrCamera camera) {
		this.camera = camera;
	...
	private Action saveAction = new AbstractAction("Apply") {
		...
		public void actionPerformed(ActionEvent arg0) {
			saveToModel();
			wizardContainer
					.wizardCompleted(PgrCameraConfigurationWizard.this);
		}
	};
